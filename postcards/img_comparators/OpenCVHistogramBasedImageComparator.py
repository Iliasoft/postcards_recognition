...
class OpenCVHistogramBasedImageComparator(AbstractImageComparator):
    @staticmethod
    def get_similarity_score(images, full_path_resolver_function):
        ...
        for pair in tqdm(pairs):
            ...
            compare_result = cv.compareHist(
                images_histograms[pair[0]], images_histograms[pair[1]], compare_method
            )
